...
<<<<<<< HEAD
    public function fiskaliziranje($data)
	{	
		
		$this->db->set('invoice_uuid',$data[invoice_uuid]);
		$this->db->set('invoice_datum_slanja',$data[invoice_datum_slanja]);
        $this->db->set('invoice_zki', $data[invoice_zki]);
        $this->db->set('invoice_jir', $data[invoice_jir]);
        $this->db->set('invoice_fiskalizirano',$data[invoice_fiskalizirano]);
        $this->db->set('invoice_naknadna_dostava',$data[invoice_naknadna_dostava]);
        $this->db->set('invoice_greska',$data[invoice_greska]);
        $this->db->set('invoice_status_id', $data[invoice_status_id]);
        $this->db->set('is_read_only', $data[is_read_only]);
