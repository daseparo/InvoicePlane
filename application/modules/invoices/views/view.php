...
<<<<<<< HEAD
        ...
        $('#btn_fiskaliziraj').click(function () {
            var items = [];
            var item_order = 1;
            $('table tbody.item').each(function () {
                var row = {};
            ...
            $.post("<?php echo site_url('invoices/ajax/save'); ?>", {
                ...
                function (data) {
                    ...
                    var response = JSON.parse(data);
                    if (response.success == '1') {
                         window.location = "<?php echo site_url('invoices/fiskaliziraj'); ?>/" + <?php echo $invoice_id; ?>;
...
<<<<<<< HEAD
                                                    <?php if ($key == $invoice->invoice_status_id) { ?>selected="selected"<?php } ?> <?php if ($key == 4) { ?>disabled<?php } ?>  >
=======
...
<<<<<<< HEAD
                                <div class="invoice-propertiesi hidden">
=======
                                <div class="invoice-properties">
>>>>>>> 84cdfbf65ebf5f859ebe7dfb2bbd6f4bcefda139
...
<div class="cf row">
			...
			<div class="details-box">
                		...
                		<div class="col-xs-12 col-sm-3">	
                               		 <div class="invoice-properties">
                                    		<label><?php echo lang('jir'); ?></label>
                                    		<input type="text" id="invoice_jir"
                                           	class="input-sm form-control"
                                           	value="<?php echo $invoice->invoice_jir; ?>"
                                        	<?php if ($invoice->is_read_only == 1) {
                                            	echo 'disabled="disabled"';
                                        } ?>>
                                	</div>
				...
				<div class="col-xs-12 col-sm-3">	
                               		 <div class="invoice-properties">
                                    		<label><?php echo lang('zki'); ?></label>
                                    		<input type="text" id="invoice_zki"
                                           	class="input-sm form-control"
                                           	value="<?php echo $invoice->invoice_zki; ?>"
                                        	     <?php if ($invoice->is_read_only == 1) {
                                                echo 'disabled="disabled"';
                                        } ?>>
                                	</div>
				...
				<div class="col-xs-12 col-sm-3">	
                               		 <div class="invoice-properties">
                                    		<label><?php echo lang('datum_slanja'); ?></label>
                                    		<input type="text" id="invoice_datum_slanja"
                                           	class="input-sm form-control"
                                           	value="<?php echo ($invoice->invoice_datum_slanja); ?>"
					...
					<div class="col-xs-12 col-sm-3 ">	
						 <div class="invoice-properties">
      				 	 ...
      				 	 <?php if ($invoice->invoice_fiskalizirano != 1) { ?>
           				 <a class="btn btn-success" onclick="return confirm('Fiskalizirajte računo potvrdom na *Uredu* (OK)')" href="<?php echo site_url("invoices/fiskaliziraj/$invoice->invoice_id");?>" >
             				  <?php echo lang('fiskaliziraj');?></a>   
                     <?php } ?>
                    	 <?php if ($invoice->invoice_fiskalizirano != 1) { ?>
           				 <button class="btn btn-success hidden" id="btn_fiskaliziraj" onclick="return confirm('Fiskalizirajte računo potvrdom na *Uredu* (OK)')" >
             				   <?php echo lang('fiskaliziraj');?> Test </button>   
					 <?php } ?>

							 <button type="button" class="btn btn-info" onclick="window.open('<?php echo site_url('invoices/generate_pdf/' . $invoice_id); ?>', '_blank');">
 
             				  <span class="fa fa-print"> Print</span></button>      
					  <input type="text" id="invoice_uuid"
                                                class="input-sm form-control"
                                                value="<?php echo $invoice->invoice_uuid; ?>"
                                                     disabled="disabled"
                                        } ?>
                ...
                <div class="col-xs-12 col-md-12">
					...
					<div class="col-xs-12 col-sm-12 ">	
						 <div class="alert alert-danger">
             				  ...
             				  <?php echo nl2br("Fiskalizacija nije uspjela !!! Provjerite datum, način plaćanja, broj računa i ostale parametre računa.Potrebno je ponovno fiskalizirati račun.  \nKod greške: ".$invoice->invoice_greska);?> 
