...
<<<<<<< HEAD
        ...
        public function rekapitulacija($from_date = null, $to_date = null)
    {
        ...
        $this->db->order_by('invoice_date_created');
        return $this->mdl_invoices->get()->result();
    }

        public function dnevni_promet($from_date = null)
    {
       ...
       $this->mdl_invoices->where('invoice_date_created <=', $from_date);
        ...
        public function lista_racuna($from_date = null, $to_date = null)
        {
