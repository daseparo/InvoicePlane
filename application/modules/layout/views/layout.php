...
<<<<<<< HEAD
                        <li class="hidden"><?php echo anchor('invoices/recurring/index', trans('view_recurring_invoices')); ?></li>
=======
...
>>>>>>> 84cdfbf65ebf5f859ebe7dfb2bbd6f4bcefda139
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
<<<<<<< HEAD
                        <li><?php echo anchor('reports/dnevni_promet', trans('dnevni_promet')); ?></li>
                        <li><?php echo anchor('reports/rekapitulacija', trans('rekapitulacija')); ?></li>
                        <li><?php echo anchor('reports/lista_racuna', trans('lista_racuna')); ?></li> 
=======
